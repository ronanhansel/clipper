...
export function getRenderableTextSegments(content: string, richText: RichTextSegment[] | undefined) {
...
export function renderRichTextSegments(segments: RichTextSegment[], explicitFormatting: boolean) {
...
export function textSegmentsToEditableNodes(segments: RichTextSegment[], explicitFormatting: boolean) {
  const nodes: Node[] = [];
...
export function getSelectionFormatState(selection: Selection, format: "bold" | "italic" | "underline") {
...
export function richTextSegmentsFromElement(element: HTMLElement, baseStyle: Record<string, string | number>) {
...
export function shouldPersistRichText(segments: RichTextSegment[], baseStyle: Record<string, string | number>) {
  const baseFormat = getBaseRichTextFormat(baseStyle);
