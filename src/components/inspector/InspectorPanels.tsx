...
export const ObjectInspector = memo(function ObjectInspector({
  ...
  const colorStyleEntries = isPattern2d
    ? []
  ...
  return (
    <div className="grid gap-3">
      ...
      {object.type === "pattern2d" ? (
        <Pattern2DSection object={object} onChange={onChange} />
      ) : null}
      {isText ? (
...
function createDefaultTextAnimator(index: number): LayerAnimation {
